...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<link rel="stylesheet" href="/Public/Admins/css/bootstrap.min.css">
	<link rel="stylesheet" href="/Public/Admins/css/animate.css">
	<link rel="stylesheet" href="/Public/Admins/css/style.css">


	<!-- Modernizr JS -->
	<script src="/Public/Admins/js/modernizr-2.6.2.min.js"></script>
	<!-- FOR IE9 below -->
	<!--[if lt IE 9]>
	...
	<!-- jQuery -->
	<script src="/Public/Admins/js/jquery.min.js"></script>
	<!-- Bootstrap -->
	<script src="/Public/Admins/js/bootstrap.min.js"></script>
	<!-- Placeholder -->
	<script src="/Public/Admins/js/jquery.placeholder.min.js"></script>
	<!-- Waypoints -->
	<script src="/Public/Admins/js/jquery.waypoints.min.js"></script>
	<!-- Main JS -->
	<script src="/Public/Admins/js/main.js"></script>
